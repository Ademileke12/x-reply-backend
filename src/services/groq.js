...
const examples = [
  ...
  "nah that’s wild go touch grass",
  ...
  "bro stop lying it’s obvious",
  "nah tell the full story",
  "i’m confused but i’ll agree",
  ...
  "bro do it again, maybe it triggers the bot 💀",
  "tell them to check the spam folder tf",
  "I’m convinced support is run by ghosts at this point",
  "nah cuz why you saying it like that 😭",
  ...
  "I’m tired of explaining this bro",
  "good morning, that thing never works for me either",
  "man y’all really think everything is airdrop now",
  "it literally says wait patiently, why rushing",
  "bro just ask support, why you asking strangers",
  "you sure it’s not your own device acting up",
  "fam stop lying for RTs, it’s embarrassing",
  "yo why everybody acting confused today 💀",
  ...
  "what’s wrong with y’all today fr",
  "morning bro, I tried it and it failed",
  "how many times you want me to repeat this 😭",
  "y’all never read the instructions damn",
  "honestly they playing with everyone’s time",
  "bro that’s not even the issue",
  "you should try again later fr",
  "why you always panicking this early",
  "that’s on you lowkey",
  "the energy is weird today bro",
  "morning dawg, this whole thing broken",
  "you ain’t listening, that’s the problem",
  "be honest, you didn’t follow the steps right",
  "nah stop blaming others bro",
  "that’s what happens when you rush",
  "you didn't even check the update notes 💀",
  "morning, same bs happened to me",
  "your tone killing me bro chill",
  "y’all love drama too much",
  ...
  "bro you didn’t need to add all that",
  "the vibe weird today ngl",
  "y’all need sleep fr",
  "morning, I feel you it’s annoying",
  "bro that’s not even the point",
  "you tryna start drama for no reason",
  "ain’t nothing wrong, you tripping",
  ...
  "bro this why nobody takes y’all serious",
  "nah this whole thread chaotic😅",
  ...
  "some of y’all should not have internet access",
